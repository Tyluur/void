...
/**
 * Void Knight dialogue implementation.
 * Ported from 2009scape's VoidKnightDialogue.java.
 *
 * NPC IDs: 3786, 3788, 3789, 5956 (Void Knights)
 */
class VoidKnightDialogue : Script {

    init {
        // Register dialogue for all Void Knight NPCs
    ...
    private suspend fun Player.whoAreYouBranch() {
        ...
        npc<Neutral>("I'm a Void Knight, one of the order of Guthix. We are warriors of balance who do Guthix's work here in Gielinor.")
        choice {
